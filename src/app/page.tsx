        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {navCards.map(({ href, icon: Icon, title, subtitle, description, color, badge }) => (
            <Link
              key={href}
              href={href}
              className="group bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 overflow-hidden border border-gray-100 hover:-translate-y-1"
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center gap-1 text-secondary text-sm font-medium group-hover:gap-2 transition-all">
